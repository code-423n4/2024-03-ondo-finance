...
task(
  ...
  const configUSDY = Network.addressConfig().USDY;
  ...
  let params: BaseProposalRequestParams = {
    via: configUSDY.PROD_GUARDIAN_USDY,
    viaType: "Gnosis Safe",
  };
  ...
  await proposeGrantRole({
    ...
    account: configUSDY.PROD_PAUSER_USDY,
  });
  console.log(
  ...
  await proposeGrantRole({
    ...
    account: configUSDY.PROD_MANAGER_ADMIN_USDY,
  });
  console.log(
