...
contract OMMFRebaseSetter is AccessControlEnumerable {
  ...
  // 0.09%, for example, if RWA price is 100 on day 1, it can't be more than
  // 100.09 or less than 99.91 on day 2
  uint256 public constant OPS_MAX_CHANGE_DIFF_BPS = 9;
