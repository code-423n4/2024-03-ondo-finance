...
import "contracts/usdy/usdyw/USDYW.sol";
 ...
 */
contract USDYW_Factory is IMulticall {
  struct USDYListData {
    address blocklist;
    address allowlist;
  ...
  USDYW public usdyImplementation;
  ...
  function deployUSDY(
    ...
    USDYW usdyProxied = USDYW(address(usdyProxy));
    usdyProxied.initialize(name, ticker, blocklist);
