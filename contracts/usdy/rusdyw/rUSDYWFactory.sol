...
import "contracts/usdy/rusdyw/rUSDYW.sol";
 ...
 */
contract rUSDYW_Factory is IMulticall {
  bytes32 public constant DEFAULT_ADMIN_ROLE = bytes32(0);

  address internal immutable guardian;
  rUSDYW public rUSDYImplementation;
  ...
  function deployrUSDY(
    ...
    rUSDYImplementation = new rUSDYW();
    ...
    rUSDYW rUSDYProxied = rUSDYW(address(rUSDYProxy));
    rUSDYProxied.initialize(blocklist, usdy, guardian, oracle);
